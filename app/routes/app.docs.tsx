...
export default function DocsPage() {
  ...
  // Scroll-spy: highlight TOC entry of section currently in viewport
  useEffect(() => {
  ...
  return (
    <div>
      ...
      {/* Hero card */}
      <div className="relative overflow-hidden rounded-2xl border border-border bg-surface mb-8 animate-slideUp">
        <div
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[240px_1fr] gap-8">
        ...
        <aside className="hidden lg:block">
          <div className="sticky top-6">
            <div className="text-[10px] uppercase tracking-[0.1em] text-faint font-semibold px-2 mb-2">
              On this page
            </div>
              ...
              {SECTIONS.map((s) => {
                ...
                return (
                  <button
                    ...
                    className={`group w-full flex items-center gap-2.5 px-2.5 py-1.5 rounded-md text-[12.5px] font-medium transition-all duration-200 ease-smooth relative ${
                      isActive
                        ? "text-ink"
                        : "text-muted hover:text-ink hover:bg-white/[0.04] hover:translate-x-[1px]"
                    }`}
                    style={
                      isActive
                  ...
                  >
                    {isActive && (
                      <span className="absolute left-0 top-1 bottom-1 w-[2.5px] rounded-r-full bg-gradient-to-b from-accent2 to-accent shadow-[0_0_10px_rgba(108,99,255,0.6)]" />
                    )}
                    <Icon
                      name={s.icon}
                      size={13}
                      className={isActive ? "text-accent2" : "group-hover:text-ink"}
        ...
        <main className="min-w-0 space-y-12">
          ...
          <Section id="portal" icon="Globe" title="Customer portal">
            ...
            <p>
              ...
              <DocLink to="/app/settings?tab=Portal">
                Settings → Portal
              </DocLink>
              .
            </p>
          ...
          <Section id="live-chat" icon="MessageCircle" title="Live chat" badge="Pro plan">
            <p>
              ...
              merchant inbox lives at{" "}
              <DocLink to="/app/messages">Messages</DocLink>.
            </p>
            <Callout kind="info">
            ...
            <h4>How it works</h4>
            <ul>
              <li>Customer clicks the 💬 button at the bottom-right of the portal.</li>
          ...
          <Section id="portal-editor" icon="Paintbrush" title="Portal editor">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 not-prose">
              ...
              <Feature icon="MessageCircle" title="Live chat">
                Enable/disable the in-portal chat widget (Pro plan).
              </Feature>
            </div>
            <Callout kind="tip">
          ...
          <Section id="settings" icon="Settings" title="Settings">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 not-prose">
              ...
              <Feature icon="Globe" title="Portal">
                Get your portal URL, embed code, and choose how to expose it.
              </Feature>
            </div>
          </Section>
          ...
          <Section id="billing" icon="CreditCard" title="Billing & plans">
            ...
            <Callout kind="info">
              All paid plans come with a <strong>14-day free trial</strong>.
              You can cancel at any time and downgrade back to Free.
            </Callout>
          </Section>
          ...
          {/* Footer CTA */}
          <div className="rounded-2xl border border-border bg-surface p-6 md:p-8 text-center mt-12 animate-slideUp">
            <Icon name="Heart" size={20} className="mx-auto mb-2 text-accent2" />
            <div className="text-[15px] font-semibold text-ink">Still have questions?</div>
            <div className="text-[13px] text-muted mt-1 mb-4">
              We typically reply within an hour. Click the lifebuoy in the bottom-right.
            </div>
          </div>
        </main>
      </div>
...
function Section({ id, icon, title, badge, children }: {
  ...
  return (
    <section id={id} className="scroll-mt-6 animate-slideUp">
...
function Callout({ kind, children }: { kind: "tip" | "info" | "warn"; children: React.ReactNode }) {
  const cfg = {
    ...
    <div className="not-prose border-b border-divider last:border-0">
      ...
      >
        <div className="overflow-hidden">
          <div className="text-[13px] text-muted leading-relaxed pb-3.5">
            {children}
          </div>
        </div>
      </div>
